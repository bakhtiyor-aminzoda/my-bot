...
4. **Calorie AI** (Личный Диетолог):
   - *Для кого:* Фитнес-тренеры, Нутрициологи, или как отдельный стартап.
   - *Польза:* Считает калории по фото еды. Просто, быстро, без ручного ввода.
